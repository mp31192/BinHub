...
def main():
    ...
    exp_opt = "segmentation_CycleOne_noresample_context"
    ...
    expConfig.RESTORE_ID = "202006060911_MICCAI2015OAR_segmentation_CycleOne_noresample"
    ...
    expConfig.net = expConfig.NoNewReversible_multiview_with_3d_mrf(Final_output=6, Input_Channels=1,
                                                                    kernel_size=(3, 3, 3),
                                                                    kernel_size_2=(3, 3, 1))
