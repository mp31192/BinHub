...
def main():
    ...
    expConfig.RESTORE_ID = "202006150950_MICCAI2015OAR_registration_alltemplate_globalmaxpooling_morechannels_distloss_scores_map"
    ...
    TRAIN_PATH = os.path.join(systemsetup.DATA_PATH, 'train_all_nii')
    VAL_PATH = os.path.join(systemsetup.DATA_PATH, 'test_all_nii')
    TEST_PATH = os.path.join(systemsetup.DATA_PATH, 'test_all_nii')
