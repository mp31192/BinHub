...
class OARDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, filePath, expConfig, template_id, mask_num=None, mode="train", hasMasks=True, AutoChangeDim=True):
        ...
        self.template_path = "/media/root/01456da2-1f1d-4b67-810e-b9cd3341133d/NPC_MICCAI_2015_original_data/HaN_2015_crop/train_all_headonly_resample_affine_template"
    ...
    def __getitem__(self, index):
        ...
        atlas_mask_path = os.path.join(self.template_path, self.template_id + '_0_template2.nii.gz')
        ...
        # atlas_image = self.ChangetoMultiChannels(atlas_image)
    ...
    def ChangetoMultiChannels(self, image):
        ...
        img_c2[img_c2 < 100] = 100
        img_c2[img_c2 > 400] = 400
        img_c2 = self.normalise_image(img_c2, min_intensity=100)
