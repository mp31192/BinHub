...
predict_path = '/media/root/01456da2-1f1d-4b67-810e-b9cd3341133d/2019_MICCAI_challenge_NPC/predictbase/202007231924_MICCAI2015OAR_registration_fixed_64channels_2_221_reg_1_template2_resample'
...
for fl in file_list:
    ...
    predict_result_path = os.path.join(predict_path, patient_id + '_0_result.nii.gz')
