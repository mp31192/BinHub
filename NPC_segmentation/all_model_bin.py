...
def threeDNet(input_shape=(None, None, 1)):
    ...
    x = GroupNormalization(groups=2, axis=GN_axis, epsilon=0.1, name='entry_flow_conv5_1_GN')(conv5)
    x = Activation('relu')(x)
    conv5 = Conv2D(512, 3, padding='same', kernel_initializer='he_normal')(x)
    x = GroupNormalization(groups=2, axis=GN_axis, epsilon=0.1, name='entry_flow_conv5_2_GN')(conv5)
    x = Activation('relu')(x)
    ...
    x = GroupNormalization(groups=2, axis=GN_axis, epsilon=0.1, name='entry_flow_conv9_2_GN')(conv9)
    x = Activation('relu')(x)

    conv10 = Conv2D(1, 1,kernel_initializer=initializers.TruncatedNormal(mean=0.5,stddev=0.5),activation='sigmoid')(x)
...
def Unet(input_shape=(None, None, 1)):
    ...
    input1 = Input(shape=(input_shape[0], input_shape[1], input_shape[2]), name='input1')
    ...
    conv10 = Conv2D(1, 1,kernel_initializer=initializers.TruncatedNormal(mean=0.2,stddev=0.1),activation='sigmoid')(conv9)
...
def threeDNet_single_deep(input_shape=(None, None, 1)):
    ...
    # 32*32
    conv42 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(pool4)
    x = BatchNormalization(axis=-1, name='entry_flow_conv42_1_GN')(conv42)
    x = LeakyReLU(alpha=0.1,name='L132')(x)
    conv42 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(x)
    x = BatchNormalization(axis=-1, name='entry_flow_conv42_2_GN')(conv42)
    x = LeakyReLU(alpha=0.1,name='L142')(x)
    # drop4 = Dropout(0.5)(conv4)
    pool42 = MaxPooling2D(pool_size=(2, 2))(x)

    # 16*16
    conv43 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(pool42)
    x = BatchNormalization(axis=-1,  name='entry_flow_conv43_1_GN')(conv43)
    x = LeakyReLU(alpha=0.1,name='L133')(x)
    conv43 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(x)
    x = BatchNormalization(axis=-1, name='entry_flow_conv43_2_GN')(conv43)
    x = LeakyReLU(alpha=0.1,name='L143')(x)
    # drop4 = Dropout(0.5)(conv4)
    pool43 = MaxPooling2D(pool_size=(2, 2))(x)

    # 8*8
    conv5 = Conv2D(256, 3, padding='same', kernel_initializer='he_normal')(pool43)
    x = GroupNormalization(groups=2, axis=-1, epsilon=0.1, name='entry_flow_conv5_1_GN')(conv5)
    x = LeakyReLU(alpha=0.1,name='L15')(x)
    conv5 = Conv2D(256, 3, padding='same', kernel_initializer='he_normal')(x)
    x = GroupNormalization(groups=2, axis=-1, epsilon=0.1, name='entry_flow_conv5_2_GN')(conv5)
    ...
    # 8*8
    merge6 = merge([conv43, (UpSampling2D(size=(2, 2))(x))], mode='concat', concat_axis=3)
    up6 = Conv2D(128, 2, padding='same', kernel_initializer='he_normal')(merge6)
    x = BatchNormalization(axis=-1, name='entry_flow_conv6_0_GN')(up6)
    x = LeakyReLU(alpha=0.1,name='uL17')(x)
    conv6 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(x)
    ...
    # 16*16
    merge7 = merge([conv42, (UpSampling2D(size=(2, 2))(x))], mode='concat', concat_axis=3)
    up7 = Conv2D(64, 2, padding='same', kernel_initializer='he_normal')(merge7)
    x = BatchNormalization(axis=-1, name='entry_flow_conv7_0_GN')(up7)
    x = LeakyReLU(alpha=0.1,name='uL19')(x)
    conv7 = Conv2D(64, 3, padding='same', kernel_initializer='he_normal')(x)
    ...
    # 32*32
    merge8 = merge([conv4, (UpSampling2D(size=(2, 2))(x))], mode='concat', concat_axis=3)
    up8 = Conv2D(64, 2, padding='same', kernel_initializer='he_normal')(merge8)
    x = BatchNormalization(axis=-1, name='entry_flow_conv8_0_GN')(up8)
    x = LeakyReLU(alpha=0.1,name='uL21')(x)
    conv8 = Conv2D(64, 3, padding='same', kernel_initializer='he_normal')(x)
    ...
    # 64*64
    merge9 = merge([conv3, (UpSampling2D(size=(2, 2))(x))], mode='concat', concat_axis=3)
    up9 = Conv2D(32, 2, padding='same', kernel_initializer='he_normal')(merge9)
    x = GroupNormalization(groups=2, axis=-1, epsilon=0.1, name='entry_flow_conv9_0_GN')(up9)
    x = LeakyReLU(alpha=0.1,name='uL23')(x)
    conv9 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(x)
    ...
    # 128*128
    merge92 = merge([conv2, (UpSampling2D(size=(2, 2))(x))], mode='concat', concat_axis=3)
    up92 = Conv2D(32, 2, padding='same', kernel_initializer='he_normal')(merge92)
    x = BatchNormalization(axis=-1, name='entry_flow_conv92_0_GN')(up92)
    x = LeakyReLU(alpha=0.1, name='uL232')(x)
    conv92 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(x)
    x = BatchNormalization(axis=-1, name='entry_flow_conv92_1_GN')(conv92)
    x = LeakyReLU(alpha=0.1, name='L232')(x)
    conv92 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(x)
    x = BatchNormalization(axis=-1, name='entry_flow_conv92_2_GN')(conv92)
    x = LeakyReLU(alpha=0.1, name='L242')(x)

    # 256*256
    merge93 = merge([conv1, (UpSampling2D(size=(2, 2))(x))], mode='concat', concat_axis=3)
    up93 = Conv2D(32, 2, padding='same', kernel_initializer='he_normal')(merge93)
    x = BatchNormalization(axis=-1, name='entry_flow_conv93_0_GN')(up93)
    x = LeakyReLU(alpha=0.1, name='uL233')(x)
    conv93 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(x)
    x = BatchNormalization(axis=-1, name='entry_flow_conv93_1_GN')(conv93)
    x = LeakyReLU(alpha=0.1, name='L233')(x)
    conv93 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(x)
    x = BatchNormalization(axis=-1, name='entry_flow_conv93_2_GN')(conv93)
    x = LeakyReLU(alpha=0.1, name='L243')(x)

    # 128*128
    conv10 = Conv2D(1, 1,kernel_initializer=initializers.TruncatedNormal(mean=0.5,stddev=0.1),activation='sigmoid')(x)
...
def threeDNet_single_deep_FPN(input_shape=(None, None, 1)):
    ...
    fpn1 = UpSampling2D(size=(2, 2))(x)
    fpn1_out = UpSampling2D(size=(2, 2))(fpn1)
    fpn1_out = Conv2D(1, 1, padding='same', kernel_initializer='he_normal',activation='sigmoid')(fpn1_out)
    ...
    fpn2 = merge([x,fpn1],mode = 'concat',concat_axis=-1)
    fpn2 = Conv2D(32,1,padding='same',kernel_initializer='he_normal')(fpn2)
    fpn2 = UpSampling2D(size=(2, 2))(fpn2)
    fpn2_out = Conv2D(1,1,padding='same', kernel_initializer='he_normal',activation='sigmoid')(fpn2)
    ...
    fpn3 = merge([x, fpn2], mode='concat', concat_axis=-1)
    fpn3 = Conv2D(32, 1, padding='same', kernel_initializer='he_normal')(fpn3)
    x = BatchNormalization(axis=-1, name='entry_flow_conv94_2_GN')(fpn3)
    x = LeakyReLU(alpha=0.1, name='L253')(x)

    # 128*128
    conv10 = Conv2D(1, 1,kernel_initializer=initializers.TruncatedNormal(mean=0.5,stddev=0.1),activation='sigmoid')(x)

    model = Model(input=[input1], output=[conv10,fpn1_out,fpn2_out])

    # model.compile(optimizer=SGD(lr=1.0e-8), loss=EuclideanLoss, metrics=['acc',precision,recall,fmeasure,tp,fp,tn,fn,yt_sum])

    return model

def threeDNet_single_deep_multi(input_shape=(None, None, 1)):

    input1 = Input(shape=(input_shape[0], input_shape[1], 1), name='input1')
    input2 = Input(shape=(int(input_shape[0]/2), int(input_shape[1]/2), 1), name='input2')
    # 512*512
    conv1 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(input1)
    # print("conv1 shape:", conv1.shape)
    # x = GroupNormalization(groups=2, axis=-1, epsilon=0.1, name='entry_flow_conv1_1_GN')(conv1)
    ...
    conv1_2 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(input2)
    print("conv1 shape:", conv1.shape)
    x = BatchNormalization(axis=-1, name='entry_flow_conv1_1_GN2')(conv1_2)
    x = LeakyReLU(alpha=0.1, name='L7')(x)
    conv1_2 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(x)
    print("conv1 shape:", conv1.shape)
    x = BatchNormalization(axis=-1, name='entry_flow_conv1_2_GN2')(conv1_2)
    x = LeakyReLU(alpha=0.1, name='L8')(x)
    pool1_2 = MaxPooling2D(pool_size=(2, 2))(x)
    print("pool1 shape:", pool1.shape)
    ...
    conv2_2 = Conv2D(64, 3, padding='same', kernel_initializer='he_normal')(pool1_2)
    print("conv2 shape:", conv2.shape)
    x = BatchNormalization(axis=-1, name='entry_flow_conv2_1_GN2')(conv2_2)
    x = LeakyReLU(alpha=0.1, name='L9')(x)
    conv2_2 = Conv2D(64, 3, padding='same', kernel_initializer='he_normal')(x)
    print("conv2 shape:", conv2.shape)
    x = BatchNormalization(axis=-1, name='entry_flow_conv2_2_GN2')(conv2_2)
    x = LeakyReLU(alpha=0.1, name='L10')(x)
    pool2_2 = MaxPooling2D(pool_size=(2, 2))(x)
    print("pool2 shape:", pool2.shape)
    ...
    conv3_2 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(pool2_2)
    print("conv3 shape:", conv3.shape)
    x = BatchNormalization(axis=-1, name='entry_flow_conv3_1_GN2')(conv3_2)
    x = LeakyReLU(alpha=0.1, name='L11')(x)
    conv3_2 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(x)
    print("conv3 shape:", conv3.shape)
    x = BatchNormalization(axis=-1, name='entry_flow_conv3_2_GN2')(conv3_2)
    x = LeakyReLU(alpha=0.1, name='L12')(x)
    pool3_2 = MaxPooling2D(pool_size=(2, 2))(x)
    print("pool3 shape:", pool3.shape)
    ...
    # 32*32
    conv42 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(concat_p)
    x = BatchNormalization(axis=-1, name='entry_flow_conv42_1_GN')(conv42)
    x = LeakyReLU(alpha=0.1,name='L132')(x)
    conv42 = Conv2D(128, 3, padding='same', kernel_initializer='he_normal')(x)
    x = BatchNormalization(axis=-1, name='entry_flow_conv42_2_GN')(conv42)
...
def RealThreeDNet_single_small_laji_2(input_shape=(None, None,None, 1)):

    input1 = Input(shape=(input_shape[0], input_shape[1],input_shape[2], 1), name='input1')

    # 128*128*64
    conv1 = Conv3D(16, 3, padding='same', kernel_initializer='he_normal')(input1)
    # print("conv1 shape:", conv1.shape)
    # x = GroupNormalization(groups=2, axis=-1, epsilon=0.1, name='entry_flow_conv1_1_GN')(conv1)
    x = BatchNormalization(axis=-1, name='entry_flow_conv1_1_GN')(conv1)
    x = LeakyReLU(alpha=0.1,name='L1')(x)
    conv1 = Conv3D(16, 3, padding='same', kernel_initializer='he_normal')(x)
    # print("conv1 shape:", conv1.shape)
    x = BatchNormalization(axis=-1, name='entry_flow_conv1_2_GN')(conv1)
    x = LeakyReLU(alpha=0.1,name='L2')(x)
    pool1 = Conv3D(16, 3, strides=2,padding='same', kernel_initializer='he_normal')(x)
    # print("pool1 shape:", pool1.shape)
    ...
    # 64*64
    up4 = Conv3DTranspose(16,kernel_size=3,strides=2,padding='same')(x)
    merge9 = merge([conv1, up4], mode='concat', concat_axis=-1)
    conv9 = Conv3D(16, 3, padding='same', kernel_initializer='he_normal')(merge9)
...
def RealThreeDNet_single_small_laji_less_pooling(input_shape=(None, None,None, 1)):
    ...
    # 8*8
    up1 = Conv3DTranspose(64,kernel_size=3,strides=2,padding='same')(x)
    merge6 = merge([conv3, up1], mode='concat', concat_axis=-1)
    conv6 = Conv3D(64, 3, padding='same', kernel_initializer='he_normal')(merge6)
    x = BatchNormalization(axis=-1, name='entry_flow_conv6_1_GN')(conv6)
    x = LeakyReLU(alpha=0.1,name='L17')(x)
    conv6 = Conv3D(64, 3, padding='same', kernel_initializer='he_normal')(x)
    ...
    merge7 = merge([conv2, up2], mode='concat', concat_axis=-1)
    ...
    merge8 = merge([conv1, up3], mode='concat', concat_axis=-1)
...
def threeDNet_multi_SE(input_shape=(None, None, 1),gn_axis = 3,GN_able = 1,GN_grou = 2,lk_alph = 0.1):
    ...
    c9 = conv_gn_leaky(up9, 3, 32, stage=9, block='b', gn_able=GN_able, gn_group=GN_grou, leaky_alpha=lk_alph,
                      strides=(1, 1))
    c9 = conv_gn_leaky(c9, 3, 32, stage=9, block='c', gn_able=GN_able, gn_group=GN_grou, leaky_alpha=1,
                      strides=(1, 1))
...
def Validnet(input_shape=(None, None, 1)):

    input1 = Input(shape=(input_shape[0], input_shape[1], input_shape[2]), name='input1')
    input2 = Input(shape=(input_shape[0], input_shape[1], input_shape[2]), name = 'input2')

    concat_input = concatenate([input1,input2],axis=-1)

    GN_axis = -1
    conv1 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(concat_input)
    print("conv1 shape:", conv1.shape)
    x = GroupNormalization(groups=2, axis=GN_axis, epsilon=0.1, name='entry_flow_conv1_1_GN')(conv1)
    x = LeakyReLU(alpha=0.1, name='L1')(x)
    conv1 = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(x)
    ...
    fc1 = Dense(256, kernel_initializer='he_normal',name='fc1')(flatten)
    x = LeakyReLU(alpha=0.1, name='L17')(fc1)
    fc2 = Dense(64, kernel_initializer='he_normal', name='fc2')(x)
    x = LeakyReLU(alpha=0.1, name='L18')(fc2)
    out = Dense(3, kernel_initializer='he_normal', name='out',activation='softmax')(x)
